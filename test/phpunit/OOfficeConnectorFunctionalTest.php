...
/**
 * \file    test/functional/OOfficeConnectorFunctionalTest.php
...
/**
 * Class OOfficeConnectorFunctionalTest
 *
 ...
 *
 * @package Testoofficeconnector
 */
class OOfficeConnectorFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modOOfficeConnector')->click();
		} else {
			// Disable the module
			$this->byHref('modOOfficeConnector')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/oofficeconnector/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('oofficeconnector/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/oofficeconnector/admin/about.php');
		$this->authenticate();
		return $this->assertContains('oofficeconnector/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('oofficeconnectorwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modOOfficeConnector_OOfficeConnectorTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modOOfficeConnector_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
