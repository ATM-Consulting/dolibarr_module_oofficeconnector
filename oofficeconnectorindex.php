...
if (! $user->rights->oofficeconnector->read) accessforbidden();
...
llxHeader("", $langs->trans("OOfficeConnectorArea"));

print load_fiche_titre($langs->trans("OOfficeConnectorArea"), '', 'oofficeconnector.png@oofficeconnector');
...
// Draft MyObject
if (! empty($conf->oofficeconnector->enabled) && $user->rights->oofficeconnector->read)
{
	$langs->load("orders");
